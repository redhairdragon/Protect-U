...
public class MainActivity extends AppCompatActivity implements
    ...
    private class HttpTask extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                URL url = new URL("http://protected-u.appspot.com/verifyid?data=" + sendThisToServer);
        ...
        protected void onPostExecute(String result) {
            ...
            String displayStr = "";
            try {
                JSONObject tempObj = new JSONObject(res);
                displayStr = "Name is " + tempObj.getString("name") + ".\nEmail is " + tempObj.getString("email") + ".\nAuthentication: " + tempObj.getString("result");
            }
            catch(JSONException ex) {
                displayStr = "user not authenticated";
            }
